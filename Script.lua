...
elseif UserID == 1197106808 or UserID == 1197106808  then  
...
elseif MsgText[2] and MsgText[2]:match('@[%a%d_]+') then  --BY USERNAME
GetUserName(MsgText[2],function(arg,data)
if not data.id_ then return sendMsg(arg.ChatID,arg.MsgID,"⇜ لآ يوجد عضـو بهذآ آلمـعرف \n") end 
...
elseif MsgText[2] and MsgText[2]:match('@[%a%d_]+') then  --BY USERNAME
GetUserName(MsgText[2],function(arg,data)
if not data.id_ then return sendMsg(arg.ChatID,arg.MsgID,"⇜  لآ يوجد عضـو بهذا آلمـعرف \n") end 
if data.type_.user_ and data.type_.user_.type_.ID == "UserTypeBot" then return sendMsg(arg.ChatID,arg.MsgID,"⇜  لا يمكنني رفع حساب بوت \n") end 
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if UserID == our_id then
...
if UserID == 1197106808 or UserID == 1197106808 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.
if UserID == 1197106808 or UserID == 1197106808 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
if UserID == our_id then   
return sendMsg(arg.ChatID,arg.MsgID,"- لا يمكنك حظر البوت ؛") 
UserID == 1197106808 or UserID == 1197106808 then 
return sendMsg(arg.ChatID,arg.MsgID,"- لا يمكنك حظر مطور السورس ؛")
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"- لا يمكنك حظر المطور الاساسي ؛")
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
...
return '- اصدار سورس روسنو : *v'..version..'* '
end

if MsgText[1] == 'اصدار السورس' or MsgText[1] == 'الاصدار' then
return 'ঌ اصدار سورس روسنو*v'..version..'* \n'
end
...
sendMsg(arg.chat_id_,arg.id_,'- عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس روسنو يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
local inline = {{{text="قناه‏‏ السـورس : روسنو ",url="t.me/rosnw1"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: روسنو](t.me/rosnw1)',nil,inline,msg.id_)
return false
end
...
local inline = {
{{text = '𝙨𝙤𝙪𝙧𝙘𝙚𝙨 𝙧𝙤𝙨𝙣𝙬 ',url="https://t.me/rosnw1"}},
{{text = '𝐃𝐄𝐕',url="https://t.me/rosnw1"}},
}   
...
NameUser = Hyper_Link_Name(data)
if UserID == 1197106808 or UserID == 1197106808 then 
...
GetUserID(FwdUser,function(arg,data)
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data,20) end
SendMention(arg.sender_user_id_,data.id_,arg.id_,"- تم ارسـاله \n- الى : "..USERNAME.." ",39,utf8.len(USERNAME)) 
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"- عذرا هذا الحساب محظور من سيرفرات حماية روسنو ") end
...
if msg.adduser == 1197106808 or msg.adduser ==  1767874645 then 
gtupe = 'مطور السورس' 
...
return sendMsg(msg.chat_id_,msg.id_,"ابوس مين سوي رد يمسلم")
end 
...
elseif Text== "مطور السورس" or Text== "مطور السورس" or Text== "مطور السورس" then return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس👑](T.ME/rosnw2)")
